...
- 当前状态与下一步：[current/project-status-snapshot.md](/Users/tongqianqiu/store/wechat-mini-shop/docs/current/project-status-snapshot.md)
- 环境配置与部署：[setup/environment-variables.md](/Users/tongqianqiu/store/wechat-mini-shop/docs/setup/environment-variables.md)
- 产品范围与首发边界：[product/product-blueprint-roadmap.md](/Users/tongqianqiu/store/wechat-mini-shop/docs/product/product-blueprint-roadmap.md)
...
- [product-blueprint-roadmap.md](/Users/tongqianqiu/store/wechat-mini-shop/docs/product/product-blueprint-roadmap.md)

### `growth/`

和分销 / 分佣相关。

- [distribution-production-checklist.md](/Users/tongqianqiu/store/wechat-mini-shop/docs/growth/distribution-production-checklist.md)

### `research/`

保留二期预研资料。

- [live-streaming-one-page.md](/Users/tongqianqiu/store/wechat-mini-shop/docs/research/live-streaming/live-streaming-one-page.md)

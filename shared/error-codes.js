const ERROR_CODES = {
  ...
  ORDER_PAYMENT_NOT_ALLOWED: { statusCode: 409, code: "ORDER_PAYMENT_NOT_ALLOWED" },
  PAYMENT_NOT_PREPARED: { statusCode: 409, code: "PAYMENT_NOT_PREPARED" },
  PAYMENT_TOKEN_INVALID: { statusCode: 400, code: "PAYMENT_TOKEN_INVALID" },
  PAYMENT_OPENID_REQUIRED: { statusCode: 409, code: "PAYMENT_OPENID_REQUIRED" },
  PAYMENT_REQUEST_INVALID: { statusCode: 400, code: "PAYMENT_REQUEST_INVALID" },
  PAYMENT_PROVIDER_NOT_READY: { statusCode: 503, code: "PAYMENT_PROVIDER_NOT_READY" },
  PAYMENT_PROVIDER_REQUEST_FAILED: { statusCode: 502, code: "PAYMENT_PROVIDER_REQUEST_FAILED" },
  PAYMENT_PROVIDER_RESPONSE_INVALID: { statusCode: 502, code: "PAYMENT_PROVIDER_RESPONSE_INVALID" },
